...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="data/3-METR-LA", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default="data/metr-la.h5", help="Raw traffic readings.",)
    parser.add_argument("--seq_length_x", type=int, default=3, help="Sequence Length.",)
